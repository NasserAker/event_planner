Feature: Dates Available
    ...
    Description:
    This feature allows users to view available dates for wedding venues independently
    of the venue search and filtering process. Users can either choose a date first and then see the available venues
